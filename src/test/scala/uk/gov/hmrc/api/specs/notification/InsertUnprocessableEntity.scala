...
class InsertUnprocessableEntity extends BaseSpec with GuiceOneServerPerSuite with TestDataNotification {
  ...
  Feature("422 UnprocessableEntity scenarios for 'Insert' record type") {
    ...
    val cases: Seq[(String, NinoPrefix, String, String)] = Seq(
      (
        "UCL_TC_008_0.9: 55006 Start Date and End Date must be earlier than Date of Death",
        "BW130",
        "55006",
        "Start Date and End Date must be earlier than Date of Death"
      ),
      (
        "UCL_TC_008_0.11: 55008 End Date must be earlier than State Pension Age",
        "EZ200",
        "55008",
        "End Date must be earlier than State Pension Age"
      ),
      (
        "UCL_TC_008_0.13: 55027 End Date later than Date of Death",
        "BK190",
        "55027",
        "End Date later than Date of Death"
      ),
      (
        "UCL_TC_008_0.5: 55029 Start Date later than SPA",
        "ET060",
        "55029",
        "Start Date later than SPA"
      ),
      (
        "UCL_TC_008_0.1: 55038 A conflicting or identical Liability is already recorded",
        "GE100",
        "55038",
        "A conflicting or identical Liability is already recorded"
      ),
      (
        "UCL_TC_008_0.19: 55039 NO corresponding liability found",
        "GP050",
        "55039",
        "NO corresponding liability found"
      ),
      (
        "UCL_TC_008_0.7: 64996 Start Date is not before date of death",
        "EK310",
        "64996",
        "Start Date is not before date of death"
      ),
      (
        "UCL_TC_008_0.15: 64997 LCW/LCWRA not within a period of UC",
        "HS260",
        "64997",
        "LCW/LCWRA not within a period of UC"
      ),
      (
        "UCL_TC_008_0.17: 64998 LCW/LCWRA Override not within a period of LCW/LCWRA",
        "CE150",
        "64998",
        "LCW/LCWRA Override not within a period of LCW/LCWRA"
      ),
      (
        "UCL_TC_008_0.3: 65026 Start date must not be before 16th birthday",
        "HC210",
        "65026",
        "Start date must not be before 16th birthday"
      ),
      (
        "UCL_TC_008_0.21: 65536 Start date before 29/04/2013",
        "GX240",
        "65536",
        "Start date before 29/04/2013"
      ),
      (
        "UCL_TC_008_0.23: 65537 End date before start date",
        "HT230",
        "65537",
      ...
      (
        "UCL_TC_008_0.25: 65541 The NINO input matches a Pseudo Account",
        "BX100",
        "65541",
        "The NINO input matches a Pseudo Account"
      ),
      (
        "UCL_TC_008_0.27: 65542 The NINO input matches a non-live account",
        "HZ310",
        "65542",
        "The NINO input matches a non-live account (including redundant, amalgamated and administrative account types)"
      ),
      (
        "UCL_TC_008_0.29: 65543 The NINO input matches an account that has been transferred to the Isle of Man",
        "BZ230",
        "65543",
        "The NINO input matches an account that has been transferred to the Isle of Man"
      ),
      (
        "UCL_TC_008_0.31: 99999 Start Date after Death",
        "AB150",
        "99999",
