...
class PositiveScenarios extends BaseSpec with GuiceOneServerPerSuite with TestDataFile {
  ...
  Feature("Positive Scenario") {
    ...
    Scenario("UCL_TC_001_0.1: Insert - LCW/LCWRA") {
      ...
      val response =
        apiService.postNotificationWithValidToken(validHeaders, validInsertLCWLCWRALiabilityRequest)
    ...
    Scenario("UCL_TC_001_0.2: Insert - UC") {
      ...
      val response =
        apiService.postNotificationWithValidToken(validHeaders, validInsertUCLiabilityRequest)
    ...
    Scenario("UCL_TC_001_0.3: Terminate - LCW/LCWRA") {
      ...
      val response =
        apiService.postNotificationWithValidToken(validHeaders, validTerminationLCWLCWRALiabilityRequest)
    ...
    Scenario("UCL_TC_001_0.4: Terminate - UC") {
      ...
      val response =
        apiService.postNotificationWithValidToken(validHeaders, validTerminationUCLiabilityRequest)
